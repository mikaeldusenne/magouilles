...
c.JupyterHub.ssl_cert = '/my-certificates/jupyterhub.crt'
c.JupyterHub.ssl_key = '/my-certificates/jupyterhub.key'
...
c.GenericOAuthenticator.token_url = environ.get("OAUTH2_TOKEN_URL", realm_stuff('token'))
c.GenericOAuthenticator.authorize_url = environ.get("OAUTH2_AUTHORIZE_URL", realm_stuff('auth'))
c.GenericOAuthenticator.userdata_url = environ.get("OAUTH2_USERDATA_URL", realm_stuff('userinfo'))
c.GenericOAuthenticator.logout_redirect_url = realm_stuff('logout')
...
# print("====================>>>>>>", public_ips())
# https://jupyterhub.readthedocs.io/en/latest/tutorial/collaboration-users.html
